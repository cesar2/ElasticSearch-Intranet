<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResultadoBusquedaImagen.aspx.cs" Inherits="ResultadoBusquedaImagen" %>
      ...
      <script>
        ...
        function actualizahits(url) {
           ...
           function actualizarEtiquetas(url, etiquetas) {
               ...
               $.ajax({
                   type: "POST",
                   url: "ResultadoBusquedaImagen.aspx/actualizarEtiquetas",
                   data: params,
                   contentType: 'application/json; charset=utf-8',
                   dataType: 'json',
                   error: function (XMLHttpRequest, textStatus, errorThrown) {
                   ...
                   success: function (data) {
                       window.location.href = "ResultadoBusquedaImagen.aspx";
                   } 
               });
           }
...
<body>
    ...
    <div>
        <center>
        <h2>Buscar Imágenes <img src="./Imagenes/icono-imagen.png"  width="32px" height="32px"/> </h2>  
        </center>
        ...
        <br />
        <p> <asp:Button runat="server" class="btn btn-primary btn-lg" OnClick="busquedaImagenes" Width="" Text="Buscar"/> </p>
    ...
    <div id="resultadoImagenes" runat="server" style="width: 800px; margin: 0 auto;">
