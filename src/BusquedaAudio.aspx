<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusquedaAudio.aspx.cs" Inherits="BusquedaAudio" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="container body-content">
             <div class="jumbotron">
          <center>
          <h1>Buscar Audios <img src="./Imagenes/icono-audio.png" height="40" width="40"/> </h1> 
          </center>
        <asp:TextBox ID="entradaBusquedaaudio"  class="form-control input-lg" runat="server" Width="500" style="margin:0 auto;"></asp:TextBox>
        <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" TargetControlID="entradaBusquedaaudio"
