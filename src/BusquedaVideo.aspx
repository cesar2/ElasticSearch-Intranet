<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusquedaVideo.aspx.cs" Inherits="BusquedaVideo" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="container body-content">
            ...
            <div class="jumbotron">
        <center>
        <h1>Buscar Videos <img src="./Imagenes/icono-video.png" height="40" width="40"/> </h1> 
        </center>
        <asp:TextBox runat="server" class="form-control input-lg" id="entradaBusquedavideo" type="text" Width="500" style="margin:0 auto;"></asp:TextBox>
          <ajaxToolkit:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server" TargetControlID="entradaBusquedavideo"
         ...
         CompletionListItemCssClass="listItem">
                ...
                <br />
        <center>
        <p> <asp:Button runat="server" class="btn btn-primary btn-lg" OnClick="busquedaVideo" Text="Buscar"/> </p>
        </center>
    </div>

            <div>
                <h2> Vídeos más buscados:</h2>
